...
class TPFA(object):
    ...
    def sens_old(self):
        Tgf_sens_interior = np.append(self.alpha[:2*self.Ni] * np.tile(self.Tgf_interior ** 2, 2) / (self.Thf_interior ** 2), 0.0) #5533 
        cell_Tgf_sens = Tgf_sens_interior[self.cell_ihfs.T] #fancy indexing, return element of a with the index given by every element of b
